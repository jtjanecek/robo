...
def generate_rc4_key() -> bytes:
    return bytes_from_hex("E7477438E0234BB8196D574F09337BE7A72971628C551C3373A68BE7F1F108181EAAC2419AFA7583215E79775E9D6DBC8D442545EF396F29C6294C69FC97E177")

def generate_server_rc4_key() -> bytes:
    return bytes_from_hex('59F5AECD5CCD444855688FAE31C271C402BDB6C090843B693644840675FBCD4DD82C6011FE3CDEDEF949B0A32DFBAE6E086538055C7B7E5C9A891357E41C8C07')
