...
COLOR_MAP_2 = {
    'a': Symbols_Unicode.DEFAULT,
    'b': Symbols_Unicode.BLUE,
    'c': Symbols_Unicode.GREEN,
    'd': Symbols_Unicode.PINK,
    'e': Symbols_Unicode.WHITE,
    'f': Symbols_Unicode.GRAY,
    'g': Symbols_Unicode.BLACK
}
